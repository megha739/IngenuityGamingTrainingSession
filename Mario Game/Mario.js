...
function preload() {
  ...
  coinSound = loadSound("sounds/Day-17 Mario_Game_sounds_coinSound.mp3");// Add Sounds
  jumpSound = loadSound("sounds/Day-17 Mario_Game_sounds_jump.mp3");// Add Sounds
  ...
  dieSound = loadSound("sounds/Day-17 Mario_Game_sounds_dieSound.mp3");// Add Sounds
